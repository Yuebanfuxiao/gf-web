...
// arModel is a active record design model for table admin_login_record operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of admin_login_record.
	Table = "admin_login_record"
	// Model is the model object of admin_login_record.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table admin_login_record.
	Columns = struct {
		Id         string //           
