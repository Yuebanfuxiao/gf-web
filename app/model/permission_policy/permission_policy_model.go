...
// arModel is a active record design model for table permission_policy operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of permission_policy.
	Table = "permission_policy"
	// Model is the model object of permission_policy.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table permission_policy.
	Columns = struct {
		Ptype  string //   
        V0     string //   
        V1     string //   
