...
// arModel is a active record design model for table permission_node operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of permission_node.
	Table = "permission_node"
	// Model is the model object of permission_node.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table permission_node.
	Columns = struct {
		Id         string //                            
        Name       string // 节点名称                   
        Label      string // 节点标签                   
        Method     string // 节点操作类型               
        Path       string // 节点路径                   
        Status     string // 节点状态 0：禁用  1：启用  
        Remark     string // 节点备注                   
