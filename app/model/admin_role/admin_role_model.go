...
// arModel is a active record design model for table admin_role operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of admin_role.
	Table = "admin_role"
	// Model is the model object of admin_role.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table admin_role.
	Columns = struct {
		AdminId  string //   
        RoleId   string //
	}{
